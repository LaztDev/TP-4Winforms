...
public abstract class Vehiculo {
    ...
    public Vehiculo(string marca, string modelo, string patente, int anio, int kilometraje, decimal precio) {
        Marca = marca;
        Modelo = modelo;
        Patente = patente;
        Anio = anio;
    ...
    public void asignarCat(decimal precio) {
        if (precio < 30000) {
    ...
    public void aplicarDescuento(int kilometraje) {
        ...
        Descuento = kilometraje > 20000 ? (int)_precio * 0.2 : 0;
...
public class Auto : Vehiculo {
    ...
    public Auto(string marca, string modelo, string patente, int anio, int kilometraje, decimal precio, int cantidadPuertas)
...
public class Moto : Vehiculo {
    ...
    public Moto(string marca, string modelo, string patente, int anio, int kilometraje, decimal precio, int cilindrada)
        : base(marca, modelo, patente, anio, kilometraje, precio) {
